...
|  --- | --- | --- | --- |
| `facade` | [`List of MediaItem`](/doc/models/media-item.md) | Required | Facade photography of a Cookies store. |
| `inside` | [`List of MediaItem`](/doc/models/media-item.md) | Required | Inside photography of a Cookies store. |
| `masthead` | [`List of MediaItem`](/doc/models/media-item.md) | Required | Masthead (featured) photography for a Cookies store. |
