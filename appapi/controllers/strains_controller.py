...
from appapi.configuration import Server
from appapi.controllers.base_controller import BaseController
from appapi.http.auth.custom_query_auth import CustomQueryAuth
from appapi.models.strain_list import StrainList


class StrainsController(BaseController):

    """A Controller to access Endpoints in the appapi API."""
